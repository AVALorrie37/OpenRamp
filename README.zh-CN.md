...
- **对话式画像**：用自然语言描述技术栈、偏好与经验，生成可匹配的开发者画像
- **智能匹配**：综合技能匹配度、项目活跃度、社区信号等，输出直观分数与说明
- **数据驱动**：GitHub API、OpenDigger 等指标；支持本地缓存与在线补全
- **可视化**：仓库列表、时间序列、词云、匹配雷达图等
- **Web 前端**：React 18 + Vite + TypeScript，浏览器中即可使用
...
- Python 3.10+
- Node.js 18+、npm
- 本地 LLM（推荐 [Ollama](https://ollama.com/)），用于对话与画像相关能力
