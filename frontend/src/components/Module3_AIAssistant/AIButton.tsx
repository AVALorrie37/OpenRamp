...
const AIButton: React.FC<AIButtonProps> = ({ onClick, language = 'chinese' }) => {
  ...
  return (
    ...
    >
      <span className="relative flex h-full min-h-0 w-full min-w-0 items-center justify-center overflow-hidden rounded-full bg-[radial-gradient(circle_at_42%_34%,color-mix(in_srgb,var(--color-primary)_88%,#ffffff_14%),color-mix(in_srgb,var(--color-radarGlow)_42%,var(--color-primaryDeep))_46%,color-mix(in_srgb,var(--color-primaryDeep)_52%,color-mix(in_srgb,var(--color-radarGlow)_42%,transparent))_62%,color-mix(in_srgb,color-mix(in_srgb,var(--color-radarGlow)_40%,var(--color-primaryDeep))_58%,var(--color-primary)_42%)_71%,color-mix(in_srgb,var(--color-primaryDeep)_38%,var(--color-primary)_62%)_80%,color-mix(in_srgb,var(--color-primary)_46%,transparent)_86%,color-mix(in_srgb,var(--color-radarGlow)_34%,transparent)_91%,color-mix(in_srgb,#ffffff_22%,transparent)_96%,color-mix(in_srgb,#ffffff_8%,transparent)_100%)] px-1">
        <span
          className="pointer-events-none absolute inset-0 rounded-full bg-[linear-gradient(165deg,color-mix(in_srgb,#ffffff_34%,transparent)_0%,color-mix(in_srgb,var(--color-primary)_22%,transparent)_55%,transparent_100%)] opacity-0 transition-opacity duration-300 ease-out group-hover:opacity-100"
          aria-hidden
        />
